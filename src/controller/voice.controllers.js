...
export const startConversation = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, result, "Conversation started successfully"));
})
...
export const processResponse = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, result, "Response processed successfully"));
})
